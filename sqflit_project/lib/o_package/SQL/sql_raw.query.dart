...
enum COLLATE { localized, nocase, binary }
...
class SQLRaw {
  ...
  ///
  SQLRaw select(String? select, {COLLATE? collate}) {
    _query +=
  ...
  SQLRaw innerJoin(String table, String onCondition) {
  ...
  SQLRaw leftJoin(String table, String onCondition) {
  ...
  /// - **Açıklama:** `kullanicilar.ad` sütunundaki değerler, kültüre özgü sıralama kurallarına göre sıralanır ve `siparisler` tablosuyla birleştirilir.
  ///
  SQLRaw where(conditions, {COLLATE? collate}) {
    _query +=
  ...
  /// - **Açıklama:** `kullanicilar.ad` sütunundaki değerler, kültüre özgü sıralama kurallarına göre sıralanır ve `siparisler` tablosuyla birleştirilir.
  ///
  SQLRaw groupBy(String column, {COLLATE? collate}) {
    _query +=
